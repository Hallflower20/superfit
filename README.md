...
[docs/cli.md](https://github.com/Hallflower20/superfit/blob/main/docs/cli.md#superfit-bank-pack).
...
![Output](https://raw.githubusercontent.com/Hallflower20/superfit/main/ZTF18abokyfk_20180925_P60_v1_10_0.png)
...
- **[Command line](https://github.com/Hallflower20/superfit/blob/main/docs/cli.md)** — every command and flag, with examples.
- **[Configuration](https://github.com/Hallflower20/superfit/blob/main/docs/configuration.md)** — every setting, what it means,
  and the Python API for passing them.
- **[Methods](https://github.com/Hallflower20/superfit/blob/main/docs/methods.md)** — what the fit actually does: the log
  wavelength grid, the extinction model, the weighting, the template bank,
  and the warnings you should not ignore.
- **[Development](https://github.com/Hallflower20/superfit/blob/main/docs/development.md)** — building an environment, running
...
MIT — see [LICENSE](https://github.com/Hallflower20/superfit/blob/main/LICENSE).
